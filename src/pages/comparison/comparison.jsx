      ...
      <div className="comparisoncontainer">
        <div className="headerImg">
          ...
          <div className="breadcrumb">
            ...
            <span className="normal">Comparison</span>
          </div>
        </div>
          ...
          <div className="sofacontainer">
            ...
            <div className="sofacomp1">
              ...
              <div class="svg-container">
                ...
                <div className="spantag">50 Review</div>
              </div>
            </div>
            <div className="sofacomp2">
              <img src="/sofa5.png" alt="" />
              <h2>Asgaard Sofa</h2>
              <span>Rs, 290,000.00</span>
              <div class="svg-container">
                <span>4.9</span>
                <svg
                  width="18"
                ...
                <div className="spantag">510 Review</div>
              </div>
            </div>
            <div className="addproduct">
              ...
              <div class="custom-select">
                <select>
                  <option selected disabled className="choose">
                    Choose a product
                  </option>
          ...
          <div className="compproducts">
            ...
            <div className="products">
              <div className="general">
                <h2>General</h2>
                <p>
                  Sales Packages <br /> Model Number <br /> Secondary Material
                  <br /> Configuration
                </p>
              </div>
              <div className="product">
                <h2>Product</h2>
                <p>
                  Filing Material <br /> Finish Type <br /> Max Capacity
              ...
              <div className="warrenty">
                <h2>Warranty</h2>
                <p>
                  Warranty Summary <br /> Service Type <br /> Covered in
                  warranty
                  <br /> Domestic Warranty
                </p>
              </div>
            </div>
            <svg
            ...
            <div className="item2">
              <div className="general">
                <p>
                  Three Seater <br /> OUTDCAW128FR33 <br /> Solid Wood
                  <br /> L-Shaped
                </p>
              </div>
              <div className="product">
                <p>
                  Matte <br /> Bright Grey & Lion <br /> 200 KG
                  <br /> Yes
                </p>
              </div>
              <div className="dimenssion">
                <p>
                  265.32 cm <br /> 76 cm <br /> 180.7 cm
                  <br /> 67 KG <br />
                  41 cm <br />
                  100.01 cm
                </p>
              ...
              <div className="warrenty">
                <p>
                  1.5 Year Warranty
                  <br /> operations@Furniro.com <br /> Manufacturing Defect only
