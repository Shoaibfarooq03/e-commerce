      ...
      <div className="checkout">
        <div className="headerImg">
          ...
          <div className="breadcrumb">
            ...
            <span className="normal">Checkout</span>
          </div>
        </div>
        ...
        <div className="billing">
          <div className="billingdetail">
            ...
            <div className="fields">
              <div className="input-fields">
                <label htmlFor="companyName">Street Address</label>
                <input
                  type="text"
                  id="companyName"
                  name="companyName"
            ...
            <div className="fields">
              <div className="input-fields">
                <label htmlFor="companyName">Town / City Name</label>
                <input
                  type="text"
                  id="companyName"
                  name="companyName"
            ...
            <div className="select">
              <div className="select-fields">
                <label htmlFor="country">Province Name</label>
                <select
                  id="countryRegion"
                  name="countryRegion"
                  style={{ width: "472px", height: "75px" }}
                >
                  ...
                  <option value="Canada">SINDH</option>
            ...
            <div className="fields">
              <div className="input-fields">
                <label htmlFor="companyName">Zip Code / Postal Code</label>
                <input
                  type="text"
                  id="companyName"
                  name="companyName"
          ...
          <div className="productdetail">
            ...
            <div className="top2" key={item.id}>
              ...
              >
                <path
                  d="M4.728 4.836L7.32 9H5.784L3.9 5.976L2.136 9H0.612L3.204 4.836L0.6 0.659999H2.136L4.032 3.708L5.808 0.659999H7.332L4.728 4.836Z"
                  fill="black"
                />
              </svg>
              <h5>{item.quantity}</h5>
            ...
            <div className="text">
              <p>
                ...
                your <br /> Order ID as the payment reference. Your order will
                not be shipped <br /> until the funds have cleared in our
                account.
              </p>
            </div>
            ...
            <div className="privacy">
              <p>
                ...
                throughout this website, to manage access to your account, <br /> and
